...
class Vector(list[T]):
    ...
    @overload
    def __setitem__(self, key: slice, value: Vector[T]) -> None: ...
    @overload
    def __setitem__(self, key: Iterable[bool], value: Vector[T]) -> None: ...
    @overload
    def __setitem__(self, key: Iterable[SupportsIndex], value: Vector[T]) -> None: ...
    @overload
