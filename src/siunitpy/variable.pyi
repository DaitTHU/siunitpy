...
class Variable(Generic[T]):
    ...
    def isexact(self, precision: T | Zero = zero) -> bool: ...
    def copy(self) -> Variable[T]: ...
    def almost_equal(self, other: Variable[T]) -> bool: ...
    def sameas(self, other: Variable[T]) -> bool: ...
    ...
    def __mul__(self, other: float | T | Variable[float] | Variable[T]) -> Variable[T]: ...
    def __matmul__(self, other: T | Variable[T]) -> Variable[T]: ...
    def __floordiv__(self, other: T | Variable[T]) -> Variable[T]: ...
    def __truediv__(self, other: float | T | Variable[float] | Variable[T]) -> Variable[T]: ...
